<?php namespace App\Http\Controllers;
	...
	class AdminTblIdentitasSiswaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tbl_identitas_siswa";
			...
			$this->form[] = ['label'=>'Jenis Kelamin','name'=>'jenis_kelamin','type'=>'select','validation'=>'required|max:255','width'=>'col-sm-10','dataenum'=>'Laki-laki;Perempuan'];
			$this->form[] = ['label'=>'Kelas','name'=>'kelas','type'=>'text','validation'=>'required|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nomor Hp','name'=>'nomor_hp','type'=>'text','validation'=>'required|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Instagram','name'=>'instagram','type'=>'text','validation'=>'max:255','width'=>'col-sm-10'];
